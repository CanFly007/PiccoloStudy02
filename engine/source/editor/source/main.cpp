...
{
	// std::filesystem::path executable_path(argv[0]); //argv[0]: D:\202303\MyPiccoloStudy01\x64\Debug\PiccoloEditor.exe
	// std::filesystem::path config_file_path = executable_path.parent_path() / "PiccoloEditor.ini"; //D:\202303\MyPiccoloStudy01\x64\Debug\PiccoloEditor.ini
